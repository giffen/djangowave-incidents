...
export default {
    ...
    data: () => ({
        dates: [],
        closedIncidents: [{ id: 1, title: 'Slow response times', end: '2019-6-4 13:00:12', start: '2020-6-3 13:00:12', update_set: [{ description: 'We have noticed some connectivity issues', date: '2020-6-3 13:00:12', status: 'Investigating' }] }]
    }),
    mounted() {
